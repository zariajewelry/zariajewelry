...
export default function EmptyState({
  ...
  return (
    <div className="py-20 px-6 flex flex-col items-center justify-center text-center bg-zariabg">
      ...
      <h3 className="text-xl font-montserratfont-medium text-black mb-4">
        {title}
      </h3>
      
      <p className="text-sm font-montserrat text-gray-700 mb-8 max-w-md leading-relaxed">
        {message}
      </p>
      ...
      {onClearFilters && (
        <Button
          ...
          className="px-8 py-2.5 bg-amber-400 hover:bg-amber-500 border border-black text-black font-montserrat transition-colors"
          type="button"
        >
